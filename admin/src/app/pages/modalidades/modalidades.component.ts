...
export class ModalidadesComponent implements OnInit {
  ...
  displayed = ['nome', 'data', 'hora', 'preco', 'acoes'];
  ...
  getByID(id: number){
    this.crudSrv.getByID('modalidades', id).subscribe(
      res => {
  ...
  post(){
    ...
    this.crudSrv.post('modalidades', this.dataForm.value).subscribe(
      res => {
        console.log(res);
  ...
  update(id: number){
    ...
    this.crudSrv.update('modalidades', id, this.dataForm.value).subscribe(
      res => {
        console.log(res);
  ...
  openModalDelete(id: number){
    ...
    dialogRef.afterClosed().subscribe(result => {
      if(result === true){
        this.crudSrv.delete('modalidades', id).subscribe(
          res => {
